package com.example.bletutorial2.data.ble
...
import com.example.bletutorial2.data.ConnectionState
import com.example.bletutorial2.data.*
import com.example.bletutorial2.data.TemperatureAndHumidityReceiveManager
...
class TemperatureAndHumidityBLEReceiveManager @Inject constructor(
    ...
    private val DEVICE_NAME = "HID OVER GATT"
    private val TEMP_HUMIDITY_SERVICE_UIID = "2bf16fcb-10c7-49d2-8d0b-65d4d21b3c97"
    private val TEMP_HUMIDITY_CHARACTERISTICS_UUID = "0279cd01-c549-497f-9fb1-6544ea188e02"
...
//            CAN ALSO SCAN FOR THIS ADDRESS
...
//                        data.emit(Resource.Success(data = TempHumidityResult(0f,0f, ConnectionState.Disconnected)))
                        data.emit(Resource.Success(data = Result(myData ="None", ConnectionState.Disconnected)))
                    }
                    gatt.close()
                }
            }else{
